...
<body class="bg-slate-900 font-sans antialiased text-slate-800 selection:bg-blue-200 selection:text-blue-900 min-h-screen flex flex-col justify-center items-center relative overflow-x-hidden px-4 py-12">
    ...
    <div class="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 md:p-10 relative z-10 animate-fade-in-up border border-slate-100 my-auto">
        ...
        <div id="successAlert" class="hidden bg-emerald-50 border-l-4 border-emerald-500 text-emerald-700 p-4 rounded-r-lg mb-4 text-sm font-medium items-center gap-3">
            <i class="fa-solid fa-circle-check text-lg"></i>
            <span>Akun berhasil didaftarkan! Mengalihkan...</span>
        </div>
        ...
        <form id="registerForm" class="space-y-4">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative input-group">
                    ...
                    <input type="email" id="email" name="email" placeholder="admin@sekolah.sch.id" class="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-11 pr-4 text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all shadow-sm" required>
                </div>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative input-group">
                    ...
                    <input type="password" id="password" name="password" placeholder="Min. 6 karakter" class="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-11 pr-12 text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all shadow-sm font-medium tracking-wider" required>
