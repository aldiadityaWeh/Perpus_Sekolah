                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4 bg-slate-50/50 flex justify-end border-b border-slate-100/50">
                        <div class="relative w-full md:w-80">
                            ...
                            <input type="text" placeholder="Cari kode / nama sumber buku..." class="w-full bg-white border border-slate-300 rounded py-2 pl-9 pr-3 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 outline-none shadow-sm placeholder:text-slate-400">
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="text-slate-700 text-[13px] divide-y divide-slate-100">
                                ...
                                <tr class="hover:bg-slate-50 transition-colors group">
                                    <td class="px-6 py-4 font-medium text-slate-500 text-center">1</td>
                                    <td class="px-6 py-4 font-mono font-bold text-slate-800">A1</td>
                                    <td class="px-6 py-4 text-slate-700 font-medium">Hibah Pemerintah</td>
                                    <td class="px-6 py-4">
                                ...
                                <!-- Baris 2 -->
                                <tr class="hover:bg-slate-50 transition-colors group">
                                    <td class="px-6 py-4 font-medium text-slate-500 text-center">2</td>
                                    <td class="px-6 py-4 font-mono font-bold text-slate-800">BOS</td>
                                    <td class="px-6 py-4 text-slate-700 font-medium">Dana BOS (Bantuan Operasional Sekolah)</td>
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center gap-1.5">
                                            <button class="w-8 h-8 rounded bg-[#ffc107] hover:bg-[#e0a800] text-slate-800 flex items-center justify-center transition-colors shadow-sm" title="Edit Data">
                                                <i class="fa-solid fa-pen-to-square text-[13px]"></i>
                                ...
                                <!-- Baris 3 -->
                                <tr class="hover:bg-slate-50 transition-colors group">
                                    <td class="px-6 py-4 font-medium text-slate-500 text-center">3</td>
                                    <td class="px-6 py-4 font-mono font-bold text-slate-800">SB</td>
                                    <td class="px-6 py-4 text-slate-700 font-medium">Sumbangan Alumni / Masyarakat</td>
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center gap-1.5">
                                            <button class="w-8 h-8 rounded bg-[#ffc107] hover:bg-[#e0a800] text-slate-800 flex items-center justify-center transition-colors shadow-sm" title="Edit Data">
                                                <i class="fa-solid fa-pen-to-square text-[13px]"></i>
                                ...
                                <!-- Baris 4 -->
                                <tr class="hover:bg-slate-50 transition-colors group">
                                    <td class="px-6 py-4 font-medium text-slate-500 text-center">4</td>
                                    <td class="px-6 py-4 font-mono font-bold text-slate-800">MB</td>
                                    <td class="px-6 py-4 text-slate-700 font-medium">Pembelian Mandiri Sekolah</td>
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center gap-1.5">
                                            <button class="w-8 h-8 rounded bg-[#ffc107] hover:bg-[#e0a800] text-slate-800 flex items-center justify-center transition-colors shadow-sm" title="Edit Data">
                                                <i class="fa-solid fa-pen-to-square text-[13px]"></i>
