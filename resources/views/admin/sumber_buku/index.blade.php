...
<body class="bg-[#f8f9fc] font-sans antialiased text-slate-800 flex h-screen overflow-hidden selection:bg-blue-200 selection:text-blue-900">
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden w-full relative bg-[#f4f7f6]">
        ...
        <header class="h-20 bg-white shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex items-center justify-between px-8 z-10 shrink-0">
            <div>
                <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Manajemen Sumber Buku</h2>
                <p class="text-sm text-slate-500 font-medium mt-0.5">Kelola data asal/sumber perolehan koleksi buku perpustakaan.</p>
            </div>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-6 custom-scrollbar">
            ...
            <div class="max-w-[1400px] mx-auto space-y-5">
                ...
                <div class="bg-[#4eb4f5] text-white rounded-lg p-5 shadow-sm border border-[#3ba0de]">
                    ...
                    <p class="text-[13px] text-white/90">Berikut ini adalah data <strong>SUMBER BUKU</strong> yang sudah tersimpan dalam database.</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4 flex items-center justify-between bg-white border-b border-slate-100">
                        ...
                        <a href="/admin/sumber-buku/create" class="bg-[#3b5998] hover:bg-[#2d4373] text-white w-8 h-8 rounded flex items-center justify-center transition-colors shadow-sm text-sm">
                    ...
                    <div class="px-6 py-4 bg-white flex justify-end border-b border-slate-100/50">
                        <div class="relative w-full md:w-72">
                            <input type="text" placeholder="Cari kode / nama sumber buku..." class="w-full bg-white border border-slate-300 rounded py-2 px-3 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 outline-none shadow-sm placeholder:text-slate-400">
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-slate-200/80 text-slate-800 text-[13px] border-y border-slate-300">
                                    ...
                                    <th class="px-6 py-3.5 font-bold w-48">Kode Sumber Buku</th>
                                    <th class="px-6 py-3.5 font-bold">Nama Sumber Buku</th>
                            ...
                            <tbody class="text-slate-700 text-[13px]">
                                ...
                                <tr class="bg-white hover:bg-slate-50 transition-colors border-b border-slate-100">
                                    ...
                                    <td class="px-6 py-3">A1</td>
                                    <td class="px-6 py-3 text-slate-600">Hibah</td>
                                    <td class="px-6 py-3">
                                ...
                                <tr class="bg-slate-100/50 hover:bg-slate-100 transition-colors border-b border-slate-100">
                                    ...
                                    <td class="px-6 py-3">N1</td>
                                    <td class="px-6 py-3 text-slate-600">Bantuan</td>
                                    <td class="px-6 py-3">
                                        <div class="flex justify-center gap-1.5">
                                ...
                                <tr class="bg-white hover:bg-slate-50 transition-colors border-b border-slate-100">
                                    ...
                                    <td class="px-6 py-3">SB</td>
                                    <td class="px-6 py-3 text-slate-600">Sumbangan</td>
                                    <td class="px-6 py-3">
                                        <div class="flex justify-center gap-1.5">
                                            <button class="w-7 h-7 rounded bg-[#ffc107] hover:bg-[#e0a800] text-slate-800 flex items-center justify-center transition-colors shadow-sm">
                                                <i class="fa-solid fa-pen-to-square text-[11px]"></i>
