    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden w-full relative">
        <header class="h-20 bg-white shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex items-center justify-between px-8 z-10 shrink-0">
            <div>
                ...
                <h2 class="text-2xl font-bold text-slate-800 tracking-tight leading-none">Tambah Sumber Buku</h2>
            </div>
            ...
            <div class="max-w-4xl mx-auto space-y-5">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2 bg-white">
                        ...
                        <h3 class="font-bold text-slate-800 text-base">Form Sumber Buku</h3>
                    </div>

                    <form action="/admin/sumber-buku" method="POST" class="p-6 md:p-8">
                        @csrf
                        <div class="space-y-6 max-w-3xl">
                            <div class="grid grid-cols-1 md:grid-cols-4 md:gap-4 items-center">
                                ...
                                <div class="md:col-span-3">
                                    <input type="text" name="kode_sumber" value="{{ old('kode_sumber') }}" placeholder="Contoh: BOS, HBH..." class="w-full bg-slate-50 border border-slate-200 rounded py-2.5 px-4 text-sm focus:outline-none focus:border-blue-500 uppercase font-mono" required autofocus>
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-4 md:gap-4 items-center">
                                <label class="text-sm font-semibold text-slate-600 mb-1 md:mb-0">Nama Sumber <span class="text-rose-500">*</span></label>
                                <div class="md:col-span-3">
                                    <input type="text" name="nama_sumber" value="{{ old('nama_sumber') }}" placeholder="Contoh: Dana BOS, Sumbangan..." class="w-full bg-slate-50 border border-slate-200 rounded py-2.5 px-4 text-sm focus:outline-none focus:border-blue-500" required>
                                </div>
                            </div>
                        </div>
