...
<body class="bg-[#f4f7f6] font-sans antialiased text-slate-800 flex h-screen overflow-hidden selection:bg-blue-200 selection:text-blue-900">
            ...
            <ul class="space-y-1.5 px-3">
                ...
                <li>
                    <a href="/admin/transaksi/peminjaman" class="flex items-center px-4 py-3 text-slate-400 hover:bg-slate-800 hover:text-white rounded-xl transition-all group">
                        <i class="fa-solid fa-barcode w-6 text-center mr-2 group-hover:text-emerald-400 transition-colors"></i> Peminjaman
                    </a>
                </li>
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden w-full relative">
        ...
        <!-- HEADER (Top Navbar Sesuai Peminjaman) -->
        <header class="h-20 bg-white shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex items-center justify-between px-8 z-10 shrink-0">
            <div>
                <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Pengembalian Buku</h2>
                <p class="text-sm text-slate-500 font-medium mt-0.5">Verifikasi pengembalian buku dan denda anggota.</p>
            </div>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-6 custom-scrollbar">
            ...
            <div class="max-w-[1400px] mx-auto space-y-6">
                ...
                <div class="bg-[#4eb4f5] text-white rounded-lg p-4 shadow-sm border border-[#3ba0de]">
                    ...
                    <p class="text-[13px] text-white/90">Silahkan scan barcode kartu anggota pada menu <strong>PENGEMBALIAN BUKU</strong> dengan posisi yang baik dan benar.</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4 bg-white flex justify-end">
                        <div class="relative w-full md:w-80">
                            <input type="text" placeholder="Cari Nama / Kelas / Tanggal..." class="w-full bg-white border border-slate-300 rounded py-2 px-3 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 outline-none shadow-sm placeholder:text-slate-400">
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-slate-200/80 text-slate-800 text-[13px] border-y border-slate-300">
                                    ...
                                    <th class="px-6 py-3.5 font-bold w-32">Status Pinjam</th>
                            ...
                            <tbody class="text-slate-700 text-[13px] divide-y divide-slate-100">
                                ...
                                <tr class="bg-white hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-3">27 April 2026</td>
                                    <td class="px-6 py-3">Rahayu</td>
                                    <td class="px-6 py-3 text-slate-600">XI Teknologi Informasi 1</td>
                                    <td class="px-6 py-3">
                                        <span class="bg-[#198754] text-white text-[11px] font-bold px-3 py-1 rounded shadow-sm inline-block">Lunas</span>
                                    </td>
                                    <td class="px-6 py-3 text-center">
                                        <button class="w-8 h-7 rounded bg-[#0dcaf0] hover:bg-[#0bacce] text-white flex items-center justify-center mx-auto transition-colors shadow-sm" title="Detail Pengembalian">
                                ...
                                <tr class="bg-slate-100/50 hover:bg-slate-100 transition-colors">
                                    ...
                                    <td class="px-6 py-3">26 April 2026</td>
                                    <td class="px-6 py-3">kasep</td>
