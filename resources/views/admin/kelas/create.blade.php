        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-8 custom-scrollbar">
            <div class="max-w-[1400px] mx-auto space-y-5">
                ...
                <div class="bg-[#4eb4f5] text-white rounded-lg p-5 shadow-sm flex flex-col justify-center">
                    ...
                    <p class="text-sm">Silahkan isi formulir data <strong>KELAS</strong> di bawah ini dengan baik dan benar.</p>
                </div>
                        ...
                        <div class="space-y-6 max-w-3xl">
                            <div class="grid grid-cols-1 md:grid-cols-4 md:gap-4 items-center">
                                ...
                                <div class="md:col-span-3">
                                    <input type="text" name="nama_kelas" value="{{ old('nama_kelas') }}" placeholder="Contoh: Kelas 1 A, Kelas 6 B..." class="w-full bg-slate-50 border border-slate-200 rounded py-2.5 px-4 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 shadow-sm" required autofocus>
                                </div>
                            </div>
                        </div>
