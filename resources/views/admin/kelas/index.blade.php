        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-6 custom-scrollbar">
            <div class="max-w-[1400px] mx-auto space-y-6">
                ...
                <div class="bg-[#4eb4f5] text-white rounded-lg p-5 shadow-sm border border-[#3ba0de] flex flex-col justify-center">
                    ...
                    <p class="text-sm text-white/90">Berikut ini adalah data rombongan belajar / <strong>KELAS</strong> yang sudah tersimpan dalam database.</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                    <div class="px-6 py-4 flex flex-col md:flex-row md:items-center justify-between bg-white border-b border-slate-100 gap-4">
                        ...
                        <a href="/admin/kelas/create" class="bg-[#3b5998] hover:bg-[#2d4373] text-white px-4 py-2 rounded flex items-center justify-center transition-colors shadow-sm text-sm font-medium gap-2">
                    ...
                    <div class="px-6 py-4 bg-slate-50/50 flex justify-end border-b border-slate-100/50">
                        <div class="relative w-full md:w-80">
                            ...
                            <input type="text" id="searchInput" placeholder="Cari nama kelas..." class="w-full bg-white border border-slate-300 rounded py-2 pl-9 pr-3 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 outline-none shadow-sm placeholder:text-slate-400">
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="text-slate-700 text-[13px] divide-y divide-slate-100" id="tableBody">
                                ...
                                <tr class="hover:bg-slate-50 transition-colors group table-row-item">
                                    ...
                                    <td class="px-6 py-4 text-slate-800 font-bold pencarian-data">{{ $item->nama_kelas }}</td>
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center gap-1.5">
                                            <a href="/admin/kelas/{{ $item->id }}/edit" class="w-8 h-8 rounded bg-[#ffc107] hover:bg-[#e0a800] text-slate-800 flex items-center justify-center transition-colors shadow-sm" title="Edit Data">
                                                <i class="fa-solid fa-pen-to-square text-[13px]"></i>
                                            </a>
                                            <button type="button" onclick="openGlobalDeleteModal('/admin/kelas/{{ $item->id }}', '{{$item->nama_kelas }}')" class="w-8 h-8 rounded bg-[#dc3545] hover:bg-[#c82333] text-white flex items-center justify-center transition-colors shadow-sm" title="Hapus Data">
                                ...
                                <tr>
                                    <td colspan="3" class="px-6 py-12 text-center text-slate-400">
                                        <i class="fa-solid fa-school text-4xl mb-3 opacity-50"></i>
