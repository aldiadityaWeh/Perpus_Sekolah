        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-8 custom-scrollbar">
            ...
            <div class="max-w-[1400px] mx-auto space-y-5">
                ...
                <div class="bg-[#4eb4f5] text-white rounded-lg p-5 shadow-sm border border-[#3ba0de] flex flex-col justify-center">
                    ...
                    <p class="text-sm text-white/90">Silahkan isi formulir <strong>JENIS BUKU</strong> di bawah ini dengan baik dan benar.</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                    ...
                    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2 bg-white">
                        ...
                        <h3 class="font-bold text-slate-800 text-base">Form Jenis Buku <span class="text-rose-500">(*)</span></h3>
                    </div>
                    ...
                    <form action="#" method="POST" class="p-6 md:p-8">
                        ...
                        <div class="space-y-6 max-w-3xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 md:gap-4 items-center">
                                ...
                                <div class="md:col-span-3">
                                    <input type="text" name="kode_jenis" placeholder="Contoh: A1, A2..." class="w-full bg-slate-50 border border-slate-200 rounded py-2.5 px-4 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 shadow-sm uppercase" autofocus required>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 md:gap-4 items-center">
                                ...
                                <div class="md:col-span-3">
                                    <input type="text" name="nama_jenis" placeholder="Contoh: Buku Fiksi, Buku Nonfiksi..." class="w-full bg-slate-50 border border-slate-200 rounded py-2.5 px-4 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 shadow-sm" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 pt-6 border-t border-slate-100 max-w-3xl">
                            ...
                            <div class="w-full flex gap-3">
                                ...
                                <a href="/admin/jenis-buku" class="bg-[#212529] hover:bg-[#1c1f23] text-white px-6 py-2.5 rounded shadow-sm transition-colors flex items-center justify-center gap-2 font-medium text-sm flex-1 md:flex-none">
