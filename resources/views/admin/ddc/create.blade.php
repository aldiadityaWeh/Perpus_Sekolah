...
<head>
    ...
    <title>Tambah DDC - SMARTPERPUS</title>
...
<body class="bg-slate-50 font-sans antialiased text-slate-800 flex h-screen overflow-hidden selection:bg-blue-200 selection:text-blue-900">
            ...
            <ul class="space-y-1.5 px-3">
                ...
                <li>
                    <a href="#" class="flex items-center px-4 py-3 bg-blue-600/10 text-blue-400 border border-blue-500/20 rounded-xl font-semibold shadow-inner transition-all">
                        <i class="fa-solid fa-layer-group w-6 text-center mr-2"></i> Klasifikasi DDC
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center px-4 py-3 text-slate-400 hover:bg-slate-800 hover:text-white rounded-xl transition-all group">
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden w-full relative bg-[#f4f7f6]">
        ...
        <!-- Header Atas (Sesuai Style Buku Create) -->
        <header class="h-20 bg-white shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex items-center justify-between px-8 z-10 shrink-0">
            <div>
                <div class="flex items-center text-sm text-slate-500 mb-1 font-semibold gap-2">
                    ...
                    <span class="hover:text-blue-600 cursor-pointer transition-colors">Klasifikasi DDC</span>
                    <i class="fa-solid fa-chevron-right text-[10px]"></i>
                    <span class="text-slate-800">Tambah Data</span>
                </div>
                <h2 class="text-2xl font-bold text-slate-800 tracking-tight leading-none">Tambah Data Klasifikasi DDC</h2>
            </div>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-8 custom-scrollbar">
            ...
            <div class="max-w-[1400px] mx-auto space-y-5">
                ...
                <div class="bg-[#4eb4f5] text-white rounded-lg p-5 shadow-sm border border-[#3ba0de]">
                    ...
                    <p class="text-[13px] text-white/90">Silahkan isi formulir <strong>KLASIFIKASI DDC</strong> dengan baik dan benar.</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                    ...
                    <form action="#" method="POST" class="flex flex-col">
                        <div class="p-6 md:p-8 space-y-6">
                            ...
                            <!-- Input Kode Klasifikasi DDC (Label di atas) -->
                            <div>
                                <label class="block text-[13px] font-semibold text-slate-500 mb-2">Kode Klasifikasi DDC</label>
                                <input type="number" name="kode_ddc" class="w-full bg-white border border-slate-300 rounded py-2 px-3 text-sm focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-400 transition-all text-slate-700 shadow-sm" autofocus required>
                            </div>

                            <!-- Input Kategori Klasifikasi DDC (Label di atas) -->
                            <div>
                                <label class="block text-[13px] font-semibold text-slate-500 mb-2">Kategori Klasifikasi DDC</label>
                                <input type="text" name="kategori" class="w-full bg-white border border-slate-300 rounded py-2 px-3 text-sm focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-400 transition-all text-slate-700 shadow-sm" required>
                            </div>

                        </div>

                        <!-- Action Buttons Area (Dengan background abu-abu terang) -->
                        <div class="bg-[#f8f9fc] border-t border-slate-200 px-6 py-4 flex items-center gap-2">
                            ...
                            <a href="/admin/ddc" class="bg-[#212529] hover:bg-[#1c1f23] text-white px-4 py-2 rounded shadow-sm transition-colors flex items-center gap-2 font-medium text-sm">
