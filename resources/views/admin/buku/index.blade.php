...
<body class="bg-slate-50 font-sans antialiased text-slate-800 flex h-screen overflow-hidden selection:bg-blue-200 selection:text-blue-900">
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden w-full relative">
        ...
        <header class="h-20 bg-white shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex items-center justify-between px-8 z-10 shrink-0">
            <div>
                <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Manajemen Data Buku</h2>
                <p class="text-sm text-slate-500 font-medium mt-0.5">Kelola koleksi perpustakaan, stok, dan cetak barcode.</p>
            </div>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-slate-50/50 p-6 md:p-8 custom-scrollbar relative">
            ...
            <div class="max-w-7xl mx-auto space-y-6">
                ...
                <div class="bg-[#4eb4f5] text-white rounded-lg p-5 shadow-sm flex flex-col justify-center">
                    ...
                    <p class="text-sm text-white/90">Berikut ini adalah data <strong>BUKU</strong> yang sudah tersimpan dalam database.</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4 flex items-center justify-between bg-white">
                        ...
                        <a href="/admin/buku/create" class="bg-[#4a5fc1] hover:bg-[#3d4ea6] text-white w-9 h-9 rounded flex items-center justify-center transition-colors shadow-sm">
                    ...
                    <div class="px-6 py-3 border-t border-b border-slate-100 flex justify-end bg-white">
                        <div class="relative w-full md:w-80">
                            <input type="text" placeholder="Cari Judul / Pengarang / Penerbit..." class="w-full bg-white border border-slate-200 rounded py-2 px-3 text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-700 outline-none shadow-sm">
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-slate-200/60 text-slate-800 text-sm border-b border-slate-300">
                                    <th class="px-4 py-4 font-bold w-12 text-center">No</th>
                                    <th class="px-4 py-4 font-bold text-center">QR Code</th>
                                    <th class="px-4 py-4 font-bold">Judul Buku</th>
                                    <th class="px-4 py-4 font-bold">Pengarang</th>
                                    <th class="px-4 py-4 font-bold">Penerbit</th>
                                    <th class="px-4 py-4 font-bold text-center">Tahun<br>Terbit</th>
                                    <th class="px-4 py-4 font-bold text-center">Gambar<br>Buku</th>
                            ...
                            <tbody class="text-slate-700 text-sm divide-y divide-slate-200">
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="px-4 py-3 text-center text-slate-600 font-medium">1</td>
                                    <td class="px-4 py-3 text-center">
                                        <!-- Dummy QR Code -->
                                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=60x60&data=BK-40012" alt="QR Code" class="w-12 h-12 mx-auto mix-blend-multiply">
                                    </td>
                                    <td class="px-4 py-3 font-medium text-slate-800">
                                        Buku Siswa Tema 1: Indahnya Kebersamaan
                                    </td>
                                    <td class="px-4 py-3 text-slate-600">Kemendikbud</td>
                                    <td class="px-4 py-3 text-slate-600">Balitbang Kemdikbud</td>
                                    <td class="px-4 py-3 text-center text-slate-600 font-medium">2017</td>
                                    <td class="px-4 py-3 text-center">
                                        <!-- Thumbnail Buku -->
                                        <img src="https://images.unsplash.com/photo-1596495578065-6e0763fa1178?auto=format&fit=crop&w=150&q=80" alt="Cover" class="w-10 h-14 object-cover mx-auto border border-slate-200 shadow-sm">
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex flex-col gap-1 items-center justify-center">
                                            <div class="flex gap-1">
                                                <button class="w-7 h-7 rounded bg-[#0dcaf0] hover:bg-[#0bacce] text-white flex items-center justify-center transition-colors shadow-sm" title="Detail">
                                                    <i class="fa-solid fa-info text-[11px]"></i>
                                                </button>
                                                <button class="w-7 h-7 rounded bg-[#ffc107] hover:bg-[#e0a800] text-white flex items-center justify-center transition-colors shadow-sm" title="Edit">
                                                    <i class="fa-solid fa-pen-to-square text-[11px]"></i>
                                                </button>
                                            </div>
                                            <button class="w-[3.75rem] h-7 rounded bg-[#dc3545] hover:bg-[#c82333] text-white flex items-center justify-center transition-colors shadow-sm" title="Hapus">
                                ...
                                <!-- Baris 2 -->
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="px-4 py-3 text-center text-slate-600 font-medium">2</td>
                                    <td class="px-4 py-3 text-center">
                                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=60x60&data=BK-60084" alt="QR Code" class="w-12 h-12 mx-auto mix-blend-multiply">
                                    </td>
                                    <td class="px-4 py-3 font-medium text-slate-800">
                                        Senang Belajar Matematika SD/MI
                                    </td>
                                    <td class="px-4 py-3 text-slate-600">Puskurbuk</td>
                                    <td class="px-4 py-3 text-slate-600">Kementerian Pendidikan</td>
                                    <td class="px-4 py-3 text-center text-slate-600 font-medium">2018</td>
                                    <td class="px-4 py-3 text-center">
                                        <img src="https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&w=150&q=80" alt="Cover" class="w-10 h-14 object-cover mx-auto border border-slate-200 shadow-sm">
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex flex-col gap-1 items-center justify-center">
                                            <div class="flex gap-1">
                                ...
                                <!-- Baris 3 -->
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="px-4 py-3 text-center text-slate-600 font-medium">3</td>
                                    <td class="px-4 py-3 text-center">
                                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=60x60&data=BK-00192" alt="QR Code" class="w-12 h-12 mx-auto mix-blend-multiply">
                                    </td>
                                    <td class="px-4 py-3 font-medium text-slate-800">
                                        Kamus Pintar Bergambar (Bilingual)
                                    </td>
                                    <td class="px-4 py-3 text-slate-600">Tim Erlangga</td>
                                    <td class="px-4 py-3 text-slate-600">Penerbit Erlangga</td>
                                    <td class="px-4 py-3 text-center text-slate-600 font-medium">2020</td>
                                    <td class="px-4 py-3 text-center">
                                        <img src="https://images.unsplash.com/photo-1512820790803-83ca734da794?auto=format&fit=crop&w=150&q=80" alt="Cover" class="w-10 h-14 object-cover mx-auto border border-slate-200 shadow-sm">
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex flex-col gap-1 items-center justify-center">
                                            <div class="flex gap-1">
                    ...
                    <!-- Paginasi -->
                    <div class="px-6 py-5 border-t border-slate-200 bg-white flex justify-center">
