...
<head>
    ...
    <title>Laporan Kas - SMARTPERPUS</title>
    <!-- Tailwind CSS -->
    ...
    <aside class="w-64 bg-[#0f172a] text-slate-300 flex flex-col h-full shadow-2xl shrink-0 transition-all duration-300 z-20">
        ...
        <nav class="flex-1 overflow-y-auto py-6 custom-scrollbar">
            <ul class="space-y-1.5 px-3">
                ...
                <!-- Laporan Kas (Aktif) -->
                <li>
                    <a href="/admin/laporan/kas" class="flex items-center px-4 py-3 bg-blue-600/10 text-blue-400 border border-blue-500/20 rounded-xl font-semibold shadow-inner transition-all">
                        <i class="fa-solid fa-file-invoice-dollar w-6 text-center mr-2"></i> Laporan Kas
                    </a>
                </li>
                <li>
        ...
        <header class="h-20 bg-white shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex items-center justify-between px-8 z-10 shrink-0">
            <div>
                ...
                <h2 class="text-2xl font-bold text-slate-800 tracking-tight leading-none">
                    <i class="fa-solid fa-money-bill-1-wave mr-1"></i> Laporan Kas
                </h2>
            </div>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-6 custom-scrollbar">
            ...
            <div class="max-w-[1400px] mx-auto space-y-6">
                ...
                <div class="bg-[#4eb4f5] text-white rounded p-4 shadow-sm border border-[#3ba0de]">
                    ...
                    <p class="text-[13px] text-white/90">Berikut ini adalah data <strong>LAPORAN KAS</strong> yang sudah tersimpan dalam database.</p>
                </div>
                        ...
                        <form action="#" method="GET" class="flex flex-col md:flex-row items-start md:items-center gap-4">
                            ...
                            <div id="dynamicFilterContainer" class="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto hidden">
                                ...
                                <div id="filterBulanan" class="w-full md:w-64 hidden">
                                    <input type="month" name="bulan" class="w-full bg-white border border-blue-300 rounded py-2 px-3 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 shadow-[0_0_0_2px_rgba(59,130,246,0.1)]">
                                </div>

                                <!-- Input Tahunan (Tipe Select Tahun) -->
                                <div id="filterTahunan" class="w-full md:w-64 hidden relative">
                                    <select name="tahun" class="w-full bg-white border border-blue-300 rounded py-2 px-3 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 shadow-[0_0_0_2px_rgba(59,130,246,0.1)] cursor-pointer">
                            ...
                            <!-- Tombol Cetak PDF -->
                            <button type="submit" class="bg-[#dc3545] hover:bg-[#c82333] text-white px-4 py-2 rounded text-sm font-medium shadow-sm transition-colors flex items-center gap-2 ml-auto md:ml-0 mt-2 md:mt-0">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-slate-200/80 text-slate-800 text-[13px] border-y border-slate-300">
                                    ...
                                    <th class="px-5 py-3 font-bold w-1/3">Tanggal Penerimaan</th>
                                    <th class="px-5 py-3 font-bold w-1/3">Sumber</th>
                                    <th class="px-5 py-3 font-bold">Nominal</th>
                                </tr>
                            </thead>
                            <tbody class="text-slate-700 text-[13px] divide-y divide-slate-100">
                                ...
                                <tr class="bg-white hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-5 py-3 text-slate-800">27 April 2026</td>
                                    <td class="px-5 py-3 text-slate-600">Denda Buku</td>
                                    <td class="px-5 py-3 text-slate-600">Rp. 3.000</td>
                                </tr>

                                <!-- Baris Data 2 -->
                                <tr class="bg-slate-50 hover:bg-slate-100 transition-colors">
                                    <td class="px-5 py-3 text-slate-600 font-medium">2</td>
                                    <td class="px-5 py-3 text-slate-800">28 April 2026</td>
                                    <td class="px-5 py-3 text-slate-600">Denda Buku</td>
                                    <td class="px-5 py-3 text-slate-600">Rp. 1.000</td>
                                </tr>

                                <!-- Total Row (Opsional, agar terlihat seperti laporan) -->
                                <tr class="bg-slate-100 font-bold text-slate-800">
                                    <td colspan="3" class="px-5 py-3 text-right">TOTAL KAS MASUK:</td>
                                    <td class="px-5 py-3 text-blue-600">Rp. 4.000</td>
                                </tr>
