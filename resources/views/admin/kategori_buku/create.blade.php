...
<head>
    ...
    <!-- Menghilangkan favicon hantu merah -->
    ...
    <aside class="w-64 bg-[#0f172a] text-slate-300 flex flex-col h-full shadow-2xl shrink-0 transition-all duration-300 z-20">
        ...
        <nav class="flex-1 overflow-y-auto py-6 custom-scrollbar">
            <ul class="space-y-1.5 px-3">
                ...
                <!-- (Bagian Transaksi & Laporan dipersingkat agar muat, Anda bisa menyesuaikannya) -->
            </ul>
        </nav>
    </aside>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-8 custom-scrollbar">
            ...
            <div class="max-w-[1400px] mx-auto space-y-5">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                    ...
                    <!-- Mengarah ke route simpan data Kategori Buku -->
                    <form action="{{ route('admin.kategori_buku.store') }}" method="POST" class="p-6 md:p-8">
                        @csrf
                        ...
                        <div class="space-y-6 max-w-3xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 md:gap-4 items-center">
                                ...
                                <div class="md:col-span-3">
                                    <input type="text" name="nama_kategori" value="{{ old('nama_kategori') }}" placeholder="Contoh: Umum, Buku Pelajaran Pokok, Filsafat..." class="w-full bg-slate-50 border border-slate-200 rounded py-2.5 px-4 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 shadow-sm" autofocus required>
                                </div>
                            </div>
                        </div>
