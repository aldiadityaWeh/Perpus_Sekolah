...
<head>
    ...
    <title>Tambah Kategori Buku - SMARTPERPUS</title>
    <!-- Tailwind CSS -->
        ...
        <header class="h-20 bg-white shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex items-center justify-between px-8 z-10 shrink-0">
            <div>
                ...
                <div class="flex items-center text-sm text-slate-500 mb-1 font-semibold gap-2">
                    ...
                    <a href="/admin/kategori-buku" class="hover:text-blue-600 transition-colors">Kategori Buku</a>
                    <i class="fa-solid fa-chevron-right text-[10px]"></i>
                    <span class="text-slate-800">Tambah Data</span>
                </div>
                <h2 class="text-2xl font-bold text-slate-800 tracking-tight leading-none">Tambah Data Kategori Buku</h2>
            </div>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-8 custom-scrollbar">
            ...
            <div class="max-w-[1400px] mx-auto space-y-5">
                ...
                <div class="bg-[#4eb4f5] text-white rounded-lg p-5 shadow-sm border border-[#3ba0de] flex flex-col justify-center">
                    ...
                    <p class="text-sm text-white/90">Silahkan isi formulir <strong>KATEGORI BUKU</strong> di bawah ini dengan baik dan benar.</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                    ...
                    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2 bg-white">
                        ...
                        <h3 class="font-bold text-slate-800 text-base">Form Kategori Buku <span class="text-rose-500">(*)</span></h3>
                    </div>
                    ...
                    <form action="#" method="POST" class="p-6 md:p-8">
                        ...
                        <div class="space-y-6 max-w-3xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 md:gap-4 items-center">
                                ...
                                <div class="md:col-span-3">
                                    <input type="text" name="nama_kategori" placeholder="Contoh: Umum, Buku Pelajaran Pokok, Filsafat..." class="w-full bg-slate-50 border border-slate-200 rounded py-2.5 px-4 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-700 shadow-sm" autofocus required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 pt-6 border-t border-slate-100 max-w-3xl">
                            ...
                            <div class="w-full flex gap-3">
                                ...
                                <a href="/admin/kategori-buku" class="bg-[#212529] hover:bg-[#1c1f23] text-white px-6 py-2.5 rounded shadow-sm transition-colors flex items-center justify-center gap-2 font-medium text-sm flex-1 md:flex-none">
