...
<body class="bg-[#f4f7f6] font-sans antialiased text-slate-800 flex h-screen overflow-hidden selection:bg-blue-200 selection:text-blue-900">
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden w-full relative">
        ...
        <header class="h-20 bg-white shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex items-center justify-between px-8 z-10 shrink-0">
            <div>
                <!-- Breadcrumb dengan gaya Chevron -->
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-8 custom-scrollbar">
            ...
            <div class="max-w-[1400px] mx-auto space-y-5">
                ...
                <div class="bg-[#4eb4f5] text-white rounded-lg p-5 shadow-sm border border-[#3ba0de]">
                    ...
                    <p class="text-[13px] text-white/90">Silahkan isi formulir <strong>KATEGORI BUKU</strong> dengan baik dan benar.</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                    ...
                    <form action="#" method="POST" class="flex flex-col">
                        <div class="p-6 md:p-8">
                            ...
                            <div>
                                <label class="block text-[13px] font-semibold text-slate-500 mb-2">Nama Kategori Buku</label>
                                <input type="text" name="nama_kategori" class="w-full bg-white border border-slate-300 rounded py-2 px-3 text-sm focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-400 transition-all text-slate-700 shadow-sm" autofocus required>
                            </div>
                        ...
                        <div class="bg-[#f8f9fc] border-t border-slate-200 px-6 py-4 flex items-center gap-2">
                            ...
                            <a href="/admin/kategori-buku" class="bg-[#212529] hover:bg-[#1c1f23] text-white px-4 py-2 rounded shadow-sm transition-colors flex items-center gap-2 font-medium text-sm">
